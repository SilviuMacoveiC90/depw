...
public class NearestBeaconManager {
    ...
    public NearestBeaconManager(Context context, List<BeaconID> beaconIDs) {
        ...
        beaconManager.setRangingListener((BeaconManager.BeaconRangingListener) (region, list) -> checkForNearestBeacon(list));
    }
    ...
    public void startNearestBeaconUpdates() {
        beaconManager.connect(() -> beaconManager.startRanging(ALL_ESTIMOTE_BEACONS));
    }
